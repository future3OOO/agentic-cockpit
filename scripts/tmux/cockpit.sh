...
Env:
  ...
  AGENTIC_POLICY_SYNC_ON_START  0|1 (default: 0; one-way project-root -> worktrees)
  AGENTIC_POLICY_SYNC_VERBOSE   0|1 (default: 0)
  AGENTIC_CODE_QUALITY_GATE     0|1 (default: 1)
  AGENTIC_CODE_QUALITY_GATE_KINDS csv (default: USER_REQUEST,ORCHESTRATOR_UPDATE,EXECUTE,PLAN_REQUEST)
  AGENTIC_EXEC_PREFLIGHT_AUTOCLEAN_DIRTY 0|1 (default: 1)
