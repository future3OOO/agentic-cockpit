...
export AGENTIC_AUTOPILOT_POST_MERGE_RESYNC_KINDS="${AGENTIC_AUTOPILOT_POST_MERGE_RESYNC_KINDS:-USER_REQUEST,ORCHESTRATOR_UPDATE}"
...
export AGENTIC_OPUS_CWD_MODE="${AGENTIC_OPUS_CWD_MODE:-agent_worktree}"
