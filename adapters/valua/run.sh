...
# Valua defaults: keep workers warm and cheap on app-server.
...
export AGENTIC_CODEX_MODEL="${AGENTIC_CODEX_MODEL:-${VALUA_CODEX_MODEL:-gpt-5.4}}"
export AGENTIC_CODEX_MODEL_REASONING_EFFORT="${AGENTIC_CODEX_MODEL_REASONING_EFFORT:-${VALUA_CODEX_MODEL_REASONING_EFFORT:-xhigh}}"
export AGENTIC_CODEX_PLAN_MODE_REASONING_EFFORT="${AGENTIC_CODEX_PLAN_MODE_REASONING_EFFORT:-${VALUA_CODEX_PLAN_MODE_REASONING_EFFORT:-xhigh}}"
export AGENTIC_CODEX_GLOBAL_MAX_INFLIGHT="${AGENTIC_CODEX_GLOBAL_MAX_INFLIGHT:-${VALUA_CODEX_GLOBAL_MAX_INFLIGHT:-6}}"
...
export AGENTIC_AUTOPILOT_EARLY_DECOMPOSITION_GATE="${AGENTIC_AUTOPILOT_EARLY_DECOMPOSITION_GATE:-1}"
...
export AGENTIC_AUTOPILOT_POST_MERGE_RESYNC="${AGENTIC_AUTOPILOT_POST_MERGE_RESYNC:-1}"
...
export VALUA_CODEX_MODEL="${VALUA_CODEX_MODEL:-$AGENTIC_CODEX_MODEL}"
export VALUA_CODEX_MODEL_REASONING_EFFORT="${VALUA_CODEX_MODEL_REASONING_EFFORT:-$AGENTIC_CODEX_MODEL_REASONING_EFFORT}"
export VALUA_CODEX_PLAN_MODE_REASONING_EFFORT="${VALUA_CODEX_PLAN_MODE_REASONING_EFFORT:-$AGENTIC_CODEX_PLAN_MODE_REASONING_EFFORT}"
export VALUA_CODEX_GLOBAL_MAX_INFLIGHT="${VALUA_CODEX_GLOBAL_MAX_INFLIGHT:-$AGENTIC_CODEX_GLOBAL_MAX_INFLIGHT}"
...
export VALUA_AUTOPILOT_EARLY_DECOMPOSITION_GATE="${VALUA_AUTOPILOT_EARLY_DECOMPOSITION_GATE:-$AGENTIC_AUTOPILOT_EARLY_DECOMPOSITION_GATE}"
...
export VALUA_AUTOPILOT_POST_MERGE_RESYNC="${VALUA_AUTOPILOT_POST_MERGE_RESYNC:-$AGENTIC_AUTOPILOT_POST_MERGE_RESYNC}"
...
export VALUA_DEPLOY_HOST="${VALUA_DEPLOY_HOST:-hetzner-chch}"
export VALUA_DEPLOY_MODE="${VALUA_DEPLOY_MODE:-auto}"
